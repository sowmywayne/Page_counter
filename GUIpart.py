...
typFile1 = Radiobutton(main_windows,text = "Docx", variable = v, value = 1).place(x = 170, y= 90)
typFile2 = Radiobutton(main_windows,text = "PDF", variable = v, value = 2).place(x = 300, y= 90) 
